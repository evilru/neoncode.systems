...
hero:
  ...
  text: "Let the LLM do the thinking."
...
|---|---|
| Step-by-step workflow instructions | Principles, decision rules, verification gates |
| Breaks when situation drifts | Adapts naturally to context |
| You manage every edge case | Model handles edge cases itself |
| Prompt gets longer with every issue | Stays minimal, stays focused |
...
::: tip Two inputs. 
The model decides how to run the interview, what to ask, when to stop, and how to structure the output.
:::
...
**→ [Visit //prompt.forge](/prompt.forge/)** &nbsp;·&nbsp; **[Back to //proto.labs](/proto.labs/)**
